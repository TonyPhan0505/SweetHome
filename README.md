# SweetHome - Android app

Sweethome is an android app for managing warehouse items. If you are a warehouse manager, this app will be a "sweet home" for your items. You can add, view, edit, filter, sort, search items. You can also use the app's barcode and serial number scanners to support you to specify the details of your items. Each of your items comes with 1 or many tags which can help you organize your items. The total estimated value and the individual values of the items are displayed at all times. This app comes with a user-friendly and highly-intuitive interface.
